...
\begin{document}
	...
	\author{
		\IEEEauthorblockN{
			Rebecca Chiara Q. De Veyra,
			Reuben Seth G. Jovellana, 
			Alejandro Jose E. Morales, \\
			Joaquin Andres D. Rodriguez, and
			Andrei Dominic O. Viguilla
		}
		\IEEEauthorblockA{
			\textit{College of Computer Studies, De La Salle University}\\
			Manila, Philippines
		}
	}
